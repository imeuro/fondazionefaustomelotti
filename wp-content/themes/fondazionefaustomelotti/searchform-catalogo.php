<form id="SearchCatalogo" class="search" method="get" action="<?php echo get_permalink( 898 ); ?>" role="search">
	...
	<ul id="FiltersCatalogo">
		...
		<li class="col-md-6 left">
			...
			<input class="search-exact-term" type="checkbox" name="exact-term"><strong>Search this exact code.</strong>
		</li>
